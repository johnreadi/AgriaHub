    ...
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register('/sw.js')
        .then(registration => {
          ...
          // Recharger automatiquement lorsque le nouveau SW prend le contrôle (avec notification et délai)
          navigator.serviceWorker.addEventListener('controllerchange', () => {
            ...
            try {
              ...
              if (portal) {
                ...
                n.style.position='fixed'; n.style.top='12px'; n.style.right='12px'; n.style.zIndex='99999';
                n.style.background='#111827'; n.style.color='#fff'; n.style.padding='10px 14px'; n.style.borderRadius='8px';
                n.style.boxShadow='0 6px 18px rgba(0,0,0,0.25)'; n.textContent='Mise à jour appliquée. Rechargement…';
              ...
              if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                ...
                try {
                  ...
                  if (portal) {
                    ...
                    n.style.position='fixed'; n.style.top='12px'; n.style.right='12px'; n.style.zIndex='99999';
                    n.style.background='#111827'; n.style.color='#fff'; n.style.padding='10px 14px'; n.style.borderRadius='8px';
                    n.style.boxShadow='0 6px 18px rgba(0,0,0,0.25)'; n.textContent='Nouvelle version disponible. Mise à jour…';
                    portal.appendChild(n);
                  }
                } catch(_) {}
            ...
            if (event.data.type === 'SW_UPDATED') {
              try {
                ...
                if (portal) {
                  ...
                  n.textContent = event.data.message || 'Application mise à jour';
                  portal.appendChild(n);
                }
              } catch(_) {}
            }
