...
const DEFAULT_TRAITEUR_CONTENT: TraiteurPageContent = {
    ...
    cards: [
        { title: "Pauses-café", description: "Viennoiseries, boissons chaudes et jus de fruits pour bien démarrer la journée.", image: "https://source.unsplash.com/random/400x300/?coffee,pastry,breakfast" },
